...
<body>
    <div class="card">
        ...
        <div class="info">
            ...
            <p><strong>Dibuat oleh:</strong> <?php echo "Puspa Dwi Setyorini"; ?></p>
        ...
        <?php
        // Contoh data buku dalam perpustakaan
        $nama_perpus  = "Perpustakaan Universitas ABC";
        $alamat_perpus = "Jl. Perpustakaan No. 123, Kota ABC";
        $telepon_perpus = "(021) 123-4567";
        $jam_buka = "08:00";
        $jam_tutup = "16:00";
        ...
        <div class="server">
            ...
            <p><strong>Hari Libur:</strong> <?php echo $hari_libur; ?></p>
        </div>
    </div>
</body>
